...
LIVE_MODULE_TABLES = {
    ...
    "dynamic-profit-protection": {
        ...
        "record_columns": (("操作时间", "checked_at", "time"), ("symbol", "symbol", "text"), ("持仓数量", "position_amt", "text"), ("开仓价", "entry_price", "text"), ("R", "r_usdt", "text"), ("浮盈倍数", "profit_r_multiple", "text"), ("新开仓后已实现盈亏", "realized_pnl_since_open", "text"), ("周期累计盈亏", "cycle_total_pnl", "text"), ("close", "latest_1m_close", "text"), ("最高价", "highest_since_open", "text"), ("历史最高浮盈", "highest_unrealized_pnl", "text"), ("当前档位", "current_tier", "text"), ("回撤", "profit_drawdown_ratio", "text"), ("阈值", "drawdown_threshold", "text"), ("平仓数量", "close_quantity", "text"), ("订单ID", "close_order_id", "text"), ("状态", "close_status", "text"), ("原因", "reason", "text")),
    },
    "hard-take-profit": {
